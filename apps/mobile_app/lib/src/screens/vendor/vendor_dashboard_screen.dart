...
class _VendorDashboardScreenState extends State<VendorDashboardScreen> {
    ...
    return Scaffold(
          ...
          Switch(
            ...
            onChanged: (val) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(val ? 'Store is ONLINE & visible to Batkhela customers' : 'Store is OFFLINE'),
                ),
              );
            },
          ),
      ...
      body: ListView(
        ...
        children: [
          ...
          // Operational KPI Metrics (4 KPIs)
          Row(
            children: [
              Expanded(
                child: KpiCard(
              ...
              Expanded(
                child: KpiCard(
                  ...
                  trend: '${ctrl.pendingOrdersCount} urgent pending',
            ...
            children: [
              Expanded(
                child: KpiCard(
                  ...
                  trend: '${ctrl.store.reviewCount} customer reviews',
                  isPositive: true,
          ...
          if (ctrl.pendingOrdersCount > 0) ...[
            Container(
              ...
              child: Row(
                children: [
                  const Icon(Icons.notifications_active, color: AppColors.coral),
                  const SizedBox(width: 12),
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        const Text(
                          'Review and accept to notify kitchen and riders immediately.',
                  ...
                  TextButton(
                    ...
                    child: const Text('View All', style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.coral)),
                  ),
                ],
              ),
            ),
  ...
  Widget _buildStoreStatusBanner(BuildContext context, VendorDemoController ctrl) {
    return Container(
      padding: const EdgeInsets.all(14),
      decoration: BoxDecoration(
        color: ctrl.store.isOpen ? AppColors.primary.withAlpha(15) : AppColors.error.withAlpha(15),
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
    ...
    if (order.status == OrderStatus.placed) {
        ...
        children: [
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Order Accepted! Kitchen assigned.')),
              );
            },
      ...
      return ElevatedButton(
        ...
        onPressed: () {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Order is now Preparing!')),
          );
        },
